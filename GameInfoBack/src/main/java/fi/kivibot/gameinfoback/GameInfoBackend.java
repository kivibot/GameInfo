...
public class GameInfoBackend {
    ...
    public void start() {
        ...
        ApiCache apic = new ApiCache(api);

        Spark.setPort(port);
        Spark.externalStaticFileLocation("../GameInfoFront/public_html/");
        ...
        Spark.before("/data/*", (request, response) -> {
            response.type("application/json");
        });
        Spark.get("/curgame/:summoner", (req, res) -> {
            System.out.println("--");
